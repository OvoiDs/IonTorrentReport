...
SNPSIFT = "/data/galaxy/software/snpEff-4.1/SnpSift.jar"
SNPEFF = "/data/galaxy/software/snpEff-4.1/snpEff.jar"
DBSNP = "/data/galaxy/genome_db/dbsnp_138.hg19.vcf"
SNPEFF_CONFIG = "/data/galaxy/software/snpEff-4.1/snpEff.config"
DBNSFP = "/data/galaxy/genome_db/dbNSFP2.5.txt.gz"
...
class OutputXls(object):
    def __init__(self,outputfile, cancerpanel, db):
        ...
        self.columns = ["Global_Conclusion", "Manual_Var_Comment", "Manual_Var_Classif", "Gene_Symbol", "Protein_Change", "Exon",
                        ...
                        "Quality", "Strand_Bias", "Amplicon_Ref"]
...
class Annotation(object):
    ...
    def rank(self, annotation, prioritize):
        ...
        if (self.type == "exonseq"):
            ...
            High = re.compile(r"splice|initiator_codon_variant|stop_retained_variant")
        ...
        if (howManyAnnotations > 1): #If more than one
            ...
            while i < howManyAnnotations:
                ...
                try:
                    ...
                    if (current_annotation[1][8] in to_look_in): 
                        prioritize = True
...
''' % (program_version_message, program_shortdesc, str(__date__))
    ...
    try:
        ...
        parser.add_argument("--histo", dest="histo", type=str)
        parser.add_argument("--conclusion", dest="conclusion", type=str)
        parser.add_argument("--cassette", dest="cassette", type=str, required=False)
        parser.add_argument("--annotator", dest="annotator", type=str)
	# Process arguments
    ...
    filename1 = "temp.dbsnp.vcf"
    filename2 = "temp.dbsnp.eff.vcf"
    filename3 = "temp.dbsnp.eff.dbnsfp.vcf"
    filename4 = "temp.annotated.vcf"
